...
#[derive(Parser)]
pub struct HotelWriteHeavyHotKeys {
...
#[async_trait]
impl util::Backend for HotelWriteHeavyHotKeys {
...
pub async fn service_hotel(_req: Request<Body>) -> Result<Response<Body>, Infallible> {
    let search_hotels_ratio = 30;
    let reservation_ratio = 70;
