...
#[derive(Parser)]
pub struct BoutiqueWriteHeavyHotKeys {
...
#[async_trait]
impl util::Backend for BoutiqueWriteHeavyHotKeys {
...
pub async fn service_boutique(_req: Request<Body>) -> Result<Response<Body>, Infallible> {
    let home_ratio = 5;
    let set_currency_ratio = 15;
    let browse_product_ratio = 10;
    let add_to_cart_ratio = 30;
    let view_cart_ratio = 10;
    let checkout_ratio = 30;
    assert_eq!(
